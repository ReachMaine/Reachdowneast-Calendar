...
/* mods:
	10Nov14 zig - change Start date/time to Date & end Date/time to End Time (hide? end date), turn off recuring event?
*/
...
<div class="tribe-events-community-details eventForm bubble" id="event_datepickers">
	...
	<table class="tribe-community-event-info" cellspacing="0" cellpadding="0">
		...
		<tr id="tribe-event-datepickers" data-startofweek="<?php echo get_option( 'start_of_week' ); ?>">
			<td>
				<?php tribe_community_events_field_label( 'EventStartDate', __('Date / Time:', 'tribe-events-community') ); ?>
			</td>
			<td>
		...
		<tr>
			<td>
				<?php tribe_community_events_field_label( 'EventEndDate', __('End Time:', 'tribe-events-community') ); ?>
			</td>
			<td>
